    ...
    if (this.reloadFlg)
    {
        ...
        switch (no)
        {
            case 0: 
                ...
                this.createModel();
                this.models[0].loadObject(gl, LAppDefine.MODEL_22);
                break;
            case 1: 
                this.releaseModel(0, gl);
                this.createModel();
                this.models[0].loadObject(gl, LAppDefine.MODEL_22_XMAS);
                break;
			case 2: 
                this.releaseModel(0, gl);
                this.createModel();
                this.models[0].loadObject(gl, LAppDefine.MODEL_22_XMAS_1);
                break;
            default:
                break;
        }
